...
function Hero() {
    return (
        <div className='container'>
            <div className='row p-3 p-md-5 mb-5 mt-5'>
            ...
            <div className='row p-3 p-md-5 mt-5 border-top text-muted' 
               ...
               <div className='col-12 col-md-6 p-3 p-md-5'>  {/* ✅ mobile pe full width */}
                ...
                <p>
               Rainmatter, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian
                capital markets.
                </p>
                <p>
                   And yet, we are always up to something new every day. Catch up on the latest updates on our blog 
                   or see what the media is saying about us or learn more about our business and product philosophies.
                </p>
                </div> 
            </div>
        </div>
