        ...
        <div className='container mt-5'>
            <div className='row '>
                ...
                <div className='col-6 p-5 '>
                    ...
                    <div>
                    <a href={tryDemo}>tryDemo<i style={{marginLeft:"15px"}}class="fa fa-arrow-right" aria-hidden="true"></i></a>
                    ...
                    <div className='mt-3  ' >
                    <a href={googlePlay}><img  className="me-4"src="media/images/googlePlayBadge.svg"/></a>
