    ...
    <footer className='border-top' style={{ backgroundColor: "#fafafa" }}>
      <div className='container mt-5'>
        ...
        <div className='row mt-5'>
          ...
          {/* First Column */}
          <div className='col-12 col-md-6 col-lg mb-4'>  {/* ✅ mobile pe full width */}
          ...
          {/* Company */}
          <div className='col-6 col-md-3 col-lg mb-4'>  {/* ✅ mobile pe 2 columns */}
            <p>Company</p>
        ...
        {/* Bottom Text */}
        <div className='mt-5 text-muted' style={{ fontSize: "14px" }}>  {/* ✅ font thoda chota */}
          <p>
